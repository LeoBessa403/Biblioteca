...
CREATE TABLE `tb_cliente` (
  ...
  CONSTRAINT `fk_TB_CLIENTE_TB_PESSOA1` FOREIGN KEY (`co_pessoa`) REFERENCES `tb_pessoa` (`co_pessoa`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tb_cliente_sistema` (
  ...
  CONSTRAINT `fk_TB_CLIENTE_SISTEMA_TB_EMPRESA1` FOREIGN KEY (`co_empresa`) REFERENCES `tb_empresa` (`co_empresa`),
...
CREATE TABLE `tb_empresa` (
  ...
  CONSTRAINT `fk_TB_EMPRESA_TB_ENDERECO1` FOREIGN KEY (`co_endereco`) REFERENCES `tb_endereco` (`co_endereco`),
...
CREATE TABLE `tb_financeiro` (
  ...
  CONSTRAINT `fk_tb_financeiro_tb_empresa1` FOREIGN KEY (`co_cliente_sistema`) REFERENCES `tb_cliente_sistema` (`co_cliente_sistema`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tb_fornecedor` (
  ...
  CONSTRAINT `fk_TB_FORNECEDOR_TB_EMPRESA1` FOREIGN KEY (`co_empresa`) REFERENCES `tb_empresa` (`co_empresa`),
  CONSTRAINT `fk_tb_fornecedor_tb_empresadwd1_idx` FOREIGN KEY (`co_cliente_sistema`) REFERENCES `tb_cliente_sistema` (`co_cliente_sistema`),
  CONSTRAINT `fk_TB_FORNECEDOR_TB_PESSOA1` FOREIGN KEY (`co_pessoa`) REFERENCES `tb_pessoa` (`co_pessoa`),
...
CREATE TABLE `tb_funcionalidade_pacote` (
  ...
  CONSTRAINT `fk_tb_funcionalidade_tb_pacote_tb_funcionalidade1` FOREIGN KEY (`co_funcionalidade`) REFERENCES `tb_funcionalidade` (`co_funcionalidade`),
  CONSTRAINT `fk_tb_funcionalidade_tb_pacote_tb_pacote1` FOREIGN KEY (`co_pacote`) REFERENCES `tb_pacote` (`co_pacote`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tb_funcionario` (
  ...
  CONSTRAINT `fk_tb_funcionario_tb_cliente_sistema_idx` FOREIGN KEY (`co_cliente_sistema`) REFERENCES `tb_cliente_sistema` (`co_cliente_sistema`),
  CONSTRAINT `fk_tb_funcionario_tb_foto1` FOREIGN KEY (`co_imagem`) REFERENCES `tb_imagem` (`co_imagem`),
  CONSTRAINT `fk_TB_FUNCIONARIO_TB_PESSOA1` FOREIGN KEY (`co_pessoa`) REFERENCES `tb_pessoa` (`co_pessoa`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tb_negociacao` (
  ...
  CONSTRAINT `fk_tb_negociacao_tb_cliente1` FOREIGN KEY (`co_cliente`) REFERENCES `tb_cliente` (`co_cliente`),
  ...
  CONSTRAINT `fk_tb_negociacao_tb_fornecedor1` FOREIGN KEY (`co_fornecedor`) REFERENCES `tb_fornecedor` (`co_fornecedor`),
  CONSTRAINT `fk_tb_negociacao_tb_tipo_negociacao1` FOREIGN KEY (`co_tipo_negociacao`) REFERENCES `tb_tipo_negociacao` (`co_tipo_negociacao`),
...
CREATE TABLE `tb_negociacao_produto` (
  ...
  CONSTRAINT `fk_tb_negociacao_tb_produto_tb_negociacao1` FOREIGN KEY (`co_negociacao`) REFERENCES `tb_negociacao` (`co_negociacao`),
  CONSTRAINT `fk_tb_negociacao_tb_produto_tb_produto1` FOREIGN KEY (`co_produto`) REFERENCES `tb_produto` (`co_produto`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tb_pacote` (
  ...
  CONSTRAINT `fk_TB_PACOTE_TB_CLIENTE_SISTEMA1` FOREIGN KEY (`co_cliente_sistema`) REFERENCES `tb_cliente_sistema` (`co_cliente_sistema`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tb_pagamento` (
  ...
  CONSTRAINT `fk_TB_PAGAMENTO_TB_NEGOCIACAO1` FOREIGN KEY (`co_negociacao`) REFERENCES `tb_negociacao` (`co_negociacao`),
...
CREATE TABLE `tb_perfil` (
  ...
  CONSTRAINT `fk_tb_perfil_tb_empresa1` FOREIGN KEY (`co_cliente_sistema`) REFERENCES `tb_cliente_sistema` (`co_cliente_sistema`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
...
CREATE TABLE `tb_perfil_produto_detalhe` (
  ...
  CONSTRAINT `fk_tb_produto_detalhe_tb_perfil_tb_perfil1` FOREIGN KEY (`co_perfil`) REFERENCES `tb_perfil` (`co_perfil`),
...
CREATE TABLE `tb_produto` (
  ...
  CONSTRAINT `fk_tb_produto_tb_categoria1` FOREIGN KEY (`co_categoria`) REFERENCES `tb_categoria` (`co_categoria`),
  CONSTRAINT `fk_tb_produto_tb_empresa1` FOREIGN KEY (`co_cliente_sistema`) REFERENCES `tb_cliente_sistema` (`co_cliente_sistema`),
...
CREATE TABLE `tb_produto_detalhe` (
  ...
  CONSTRAINT `fk_tb_financeiro_produto_tb_produto1` FOREIGN KEY (`co_produto`) REFERENCES `tb_produto` (`co_produto`),
  CONSTRAINT `fk_tb_produto_detalhe_tb_usuario1` FOREIGN KEY (`co_usuario`) REFERENCES `tb_usuario` (`co_usuario`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tb_produto_promocao` (
  ...
  CONSTRAINT `fk_tb_produto_promocao_tb_usuario1` FOREIGN KEY (`co_usuario`) REFERENCES `tb_usuario` (`co_usuario`),
...
CREATE TABLE `tb_representante` (
  ...
  CONSTRAINT `fk_TB_REPRESENTANTE_TB_PESSOA1` FOREIGN KEY (`co_pessoa`) REFERENCES `tb_pessoa` (`co_pessoa`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tb_unidade_venda` (
  ...
  CONSTRAINT `fk_tb_unidade_venda_tb_empresa1` FOREIGN KEY (`co_cliente_sistema`) REFERENCES `tb_cliente_sistema` (`co_cliente_sistema`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
