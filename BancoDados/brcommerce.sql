...
INSERT INTO `tb_empresa` (`co_empresa`, `no_empresa`, `no_fantasia`, `dt_cadastro`, `nu_cnpj`, `nu_insc_estadual`, `ds_observacao`, `st_status`, `co_contato`, `co_pessoa`, `co_endereco`) VALUES
(1, 'Nome da Empresa', 'Nome de fantasia', '2016-11-18', NULL, NULL, NULL, 'I', 1, 1, 1);

INSERT INTO `tb_cliente_sistema` (`co_cliente_sistema`, `dt_cadastro`, `ds_observacao`, `st_status`, `co_pessoa`, `co_empresa`) VALUES
(1, '2016-11-18', NULL, 'I', 1, 1);
...
INSERT INTO `tb_tipo_negociacao` (`co_tipo_negociacao`, `no_tipo_negociacao`, `sg_tipo_negociacao`) VALUES
(1, 'Compra', 'CP'),
(2, 'Venda', 'VD'),
(3, 'Cotação', 'CT'),
(4, 'Orçamento', 'OR'),
...
(1, 'leobessa', '123456**', 'TVRJek5EVTJLaW89', 'A', '2016-10-31 00:00:00', 1, 1, 1);
